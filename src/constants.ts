...
export const translations = {
  IT: {
    ...
    services: 'Servizi',
    profile: 'Profilo',
    searchPlaceholder: 'Cerca servizi, trasporti, ticket...',
    logout: 'Esci',
    ...
    feedbackTitle: 'Invia una segnalazione',
    feedbackPlaceholder: 'Segnalazione o suggerimento',
    submitFeedbackBtn: 'Invia la segnalazione',
    faqTitle: 'FAQ',
    ...
    toastFeedbackSent: 'Segnalazione aperta nel client email',
    ...
    notificationActive: 'Attive',
    notificationArchive: 'Archivio',
    notificationSwipeArchive: 'Archivia',
    notificationSwipeRestore: 'Ripristina',
    notificationSwipeDelete: 'Elimina',
    notificationDetailTitle: 'Dettaglio Notifica',
    notificationArchivedToast: 'Notifica archiviata',
    notificationRestoredToast: 'Notifica ripristinata',
    notificationDeletedToast: 'Notifica eliminata',
    noArchivedNotifications: 'Nessuna notifica in archivio',
  ...
  EN: {
    ...
    services: 'Services',
    profile: 'Profile',
    searchPlaceholder: 'Search services, transport, tickets...',
    logout: 'Logout',
    ...
    feedbackTitle: 'Send a report',
    feedbackPlaceholder: 'Bug report or suggestion',
    submitFeedbackBtn: 'Send report',
    faqTitle: 'FAQ',
    ...
    toastFeedbackSent: 'Report opened in email client',
    ...
    notificationSwipeArchive: 'Archive',
    notificationSwipeRestore: 'Restore',
    notificationSwipeDelete: 'Delete',
    notificationDetailTitle: 'Notification Detail',
    notificationArchivedToast: 'Notification archived',
    notificationRestoredToast: 'Notification restored',
    notificationDeletedToast: 'Notification deleted',
    noArchivedNotifications: 'No notifications in archive',
    studentRole: 'Student',
    teacherRole: 'Teacher',
    ptaRole: 'PTA',
  },
